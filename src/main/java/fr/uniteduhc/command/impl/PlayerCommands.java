...
import fr.uniteduhc.messaging.packet.LinkSuccessPacket;
import fr.uniteduhc.messaging.packet.MessagePacket;
import fr.uniteduhc.punishment.menu.ReportMenu;
...
public class PlayerCommands {
    ...
    public static void acceptLink(Player sender, @Param(name = "data") String data) {
        ...
        }, new ItemBuilder(Material.PAPER).setName("&6&lLink").toItemStack(), null).openMenu(sender);
    }
    ...
    public static void unlink(Player sender) {
        ...
        }, new ItemBuilder(Material.PAPER).setName("&6&lUnlink").toItemStack(), null).openMenu(sender);
