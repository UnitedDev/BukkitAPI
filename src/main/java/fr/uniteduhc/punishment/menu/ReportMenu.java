...
import fr.uniteduhc.manager.report.Report;
...
public class ReportMenu extends Menu {
    ...
    private class ReportButton extends Button {
        ...
        public ItemStack getButtonItem(Player p0) {
            ...
            lore.add(" ");
            lore.add("&f&l» &eCliquez-ici pour report");

            return new ItemBuilder(value.getMaterial()).setName("&6&l" + value.getDisplay()).setLore(lore).toItemStack();
        }
        ...
        public void clicked(Player player, int slot, ClickType clickType, int hotbarButton) {
            new ConfirmationMenu(() -> {
                ...
                fr.uniteduhc.common.cache.data.Report report = new fr.uniteduhc.common.cache.data.Report(
                        new Date(),
                        UUID.randomUUID(),
                        target.getUniqueId(),
                        player.getUniqueId(),
